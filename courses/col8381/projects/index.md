...
- Sanket Rout and Vinayak Vishwakarma’s project explored the meaning of consent when it comes to AI trained on internet data. Their web-based resource (available [here](https://sanketrt.github.io/Open-Agency/)) serves as a guide for artists and creators on the current state of AI regulation, and provides an overview of tools available to protect their work from AI-based replication. 
- Arnav Raj built a simple-and-effective plugin (available [here](https://chromewebstore.google.com/detail/scrubly-ai-privacy-shield/gmjfommkpnhjjbgnnlbhiomcdfaodmae?pli=1)) to protect people’s private identifying information from being shared during their interactions with chatbots, while also ensuring that user experience is not degraded.
- Arindam Dongre and Pratik Chaudhri created a [website](https://gray-flower-028738a00.7.azurestaticapps.net/) on the environmental costs associated of chatbot interactions, drawing attention to the growing climate impact of modern AI tools.
